...
docker run --rm --name optimus-app -ti --link optimus-db -v $GOPATH:/go -w /go/src/github.com/cloudflavor/optimus-api -p 8000:8000 -p 8080:8080 golang:1.10-stretch /bin/bash
