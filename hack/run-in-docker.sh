...
echo -n "CERT_PATH=\"/go/src/github.com/cloudflavor/optimus-api/certificate.pem\" KEY_PATH=\"/go/src/github.com/cloudflavor/optimus-api/key.pem\" go run cmd/api/main.go"
